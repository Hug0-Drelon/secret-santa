 ...
 */
final class Version20210402124559 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, host_id INT NOT NULL, name VARCHAR(255) NOT NULL, comment LONGTEXT DEFAULT NULL, amount INT DEFAULT NULL, place VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_3BAE0AA71FB8D185 (host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
