 ...
 */
final class Version20210402124902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
    }
